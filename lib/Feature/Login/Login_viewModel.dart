...
class LoginViewmodel with ChangeNotifier{
  ...
  LoginViewmodel({required WorkerManager workermanager}) : _workerManager = workermanager;
  ...
  Future<AuthStatus> login() async {
    ...
    try{
      final result = await _workerManager.executeTask(WorkerName.authentication, null);
      _setLoading(false);

      if(result is AuthStatus) return result;
      else return AuthStatus.error;
    }
    catch(e){
